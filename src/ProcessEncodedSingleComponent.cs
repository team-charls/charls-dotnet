...
internal class ProcessEncodedSingleComponentToLine8Bit3ComponentsHP1 : IProcessLineEncoded
{
    public void NewLineRequested(ReadOnlySpan<byte> source, Span<byte> destination, int pixelCount)
    {
        var sourceTriplet = MemoryMarshal.Cast<byte, Triplet<byte>>(source);
...
internal class ProcessEncodedSingleComponentToLine8Bit3ComponentsHP2 : IProcessLineEncoded
{
    public void NewLineRequested(ReadOnlySpan<byte> source, Span<byte> destination, int pixelCount)
    {
        var sourceTriplet = MemoryMarshal.Cast<byte, Triplet<byte>>(source);
...
internal class ProcessEncodedSingleComponentToLine8Bit3ComponentsHP3 : IProcessLineEncoded
{
    public void NewLineRequested(ReadOnlySpan<byte> source, Span<byte> destination, int pixelCount)
    {
        var sourceTriplet = MemoryMarshal.Cast<byte, Triplet<byte>>(source);
